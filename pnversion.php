...
$modversion['description']      = __('A name and address book is for storing entries called contacts. Each contact entry usually consists of a few standard fields.', $dom);
