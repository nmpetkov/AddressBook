...
/* $Id: GoogleMapAPI.class.php 39 2010-01-31 18:16:33Z herr.vorragend $ */
    ...
    */                                                                                                                           
    ...
    function getMapJS() {
        ...
        if($this->zoom_encompass && count($this->_markers) > 1) {
            ...
            $_output .= sprintf('var bds = new GLatLngBounds(new GLatLng(%s, %s), new GLatLng(%s, %s));', number_format($this->_min_lat, 6, ".", ""), number_format($this->_min_lon, 6, ".", ""), number_format($this->_max_lat, 6, ".", ""), number_format($this->_max_lon, 6, ".", "")) . "\n";
